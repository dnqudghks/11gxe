    ...
    문제 2 ]
        ...
        2.
            회원들의
                ...
                아바타      - 숫자 2자리, 참조키 제약조건 추가
                출생일      - 문자 10 글자,  '2021/02/03'
                가입일      - 날짜데이터 기본값 현재시간
            ...
            회원번호는 시퀀스 memb_seq 를 만들어서 사용하세요.
            
            3. 두테이블을 만들고 데이터를 입력한 후
...
/*
    EXTRA ]
        ...
        게시글을 조회해서
        한페이지에 5개씩 리스트를 보여주는 
        첫페이지 데이터를 조회하는 질의명령을 작성해보세요.
        
        리스트에 포함될 데이터는
             게시글번호, 작성자아이디, 게시글 제목, 작성일, 조회수
        가 보여야 합니다.
        첫페이지를 보여줘야 하니 이 인라인뷰는 5개의 행으로
        결과가 발생해야 합니다.
        
        게시글 등록 수는 11개 이상을 등록해주세요...
        
        
        게시판 테이블은 정규화 과정을 거쳐서 테이블 설계를 해보시기 바랍니다.
        
------------------------------------------------------------------------------------------

    리스트에서 글을 클릭하면 상세보기 페이지로 이동할텐데
    이때 필요한 데이터를 꺼내오는 질의 명령을 작성하세요.
    
    필요 데이터는
        글번호, 제목, 본문, 작성자아이디, 작성일, 클릭수, 
        아바타번호, 아바타 저장경로, 아바타 저장이름
    을 조회 하세요.
*/
